      ...
      >
        <SwiperSlide>
          <div className='border-8 border-[#944E63] rounded-md p-4'>
            ...
            <p className='text-center mt-1 text-[18px] font-serif max-[651px]:text-[12px]'>Cold Relief</p>
            </div>
            </SwiperSlide>
        <SwiperSlide>
        <div className='border-8 border-[#944E63] rounded-md p-4'>
            ...
            <p className='text-center mt-1 font-serif'>Cold and Flu</p>
            </div>
        </SwiperSlide>
        <SwiperSlide>
        <div className='border-8 border-[#944E63] rounded-md p-4'>
            <img src="https://prakashhospitals.in/wp-content/uploads/2022/06/diabetic-care-seniors-1.jpg" alt="" />
            <p className='text-center mt-1 font-serif'>Diabetes and Care</p>
            </div>
        </SwiperSlide>
        <SwiperSlide>
        <div className='border-8 border-[#944E63] rounded-md p-4'>
            <img src="https://mtltimes.ca/wp-content/uploads/2021/02/improve-your-digestive-health-1.jpg" alt="" />
            <p className='text-center mt-1 font-serif'>Digestive Health</p>
            </div>
        </SwiperSlide>
        <SwiperSlide>
        <div className='border-8 border-[#944E63] rounded-md p-4'>
            ...
            <p className='text-center mt-1 font-serif'>First Aid</p>
            </div>
        </SwiperSlide>
        <SwiperSlide>
        <div className='border-8 border-[#944E63] rounded-md p-4'>
