...
function Home1() {
  return (
    ...
    <div className=" h-fit-content flex justify-around items-center lg:flex-row  flex-col ">
      <div className="p-5">
      <h1 className="text-[30px] font-bold max-[405px]:text-[25px] max-[400px]:text-[18px]">Your prescription for <br /> affordable health <br /> solutions!</h1>
      <p className=" mt-3 max-[400px]:text-[15px]" >Lorem ipsum, dolor sit amet consectetur adipisicing elit. <br /> Sit beatae eos fugit culpa unde tempore! Quos <br /> placeat veritatis impedit illo?</p>
      <div className="mt-3">
