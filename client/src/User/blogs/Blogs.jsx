...
function Blogs() {
  return (
    ...
    <div className="p-10 m-10 flex gap-3 flex-col lg:flex-row">
      <div className="border rounded-md">
     <div>
        <img className="w-[450px] h-64 max-[405px]:w-[300px] max-[405px]:h-40" src="https://assets-global.website-files.com/606ac6e3ee6c2713890937ef/608c717ada7dbf797c4279a8_Header%20image%205%20things%20good%20prescription%20plan.png" alt="" />
     </div>
     ...
     <div className="p-3">
        ...
        feature.from cardiology to padiatrics,we share-in depth articles written <br />
